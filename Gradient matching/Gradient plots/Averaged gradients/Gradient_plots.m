...
% spatial/temporal gradients at different locations of the 1D spatial 
% domain (boundaries excluded), averaged over different time points 
% and 200 data sets at different CVs.
...
grad_true_gam = readtable('Mean reference data grads gam.txt');
grad_true_fds = readtable('Mean reference data grads fds.txt');
...
tc_temp_true_gam = table2array(grad_true_gam(1,2:79));
dn_spat_true_gam = table2array(grad_true_gam(2,2:79));
ga_spat_true_gam = table2array(grad_true_gam(3,2:79));
rn_spat_true_gam = table2array(grad_true_gam(4,2:79));
ecm_temp_true_gam = table2array(grad_true_gam(5,2:79));
ita_spat_true_gam = table2array(grad_true_gam(6,2:79));
mde_temp_true_gam = table2array(grad_true_gam(7,2:79));
dm_spat_true_gam = table2array(grad_true_gam(8,2:79));
alpha_spat_true_gam = table2array(grad_true_gam(9,2:79));

tc_temp_true_fds = table2array(grad_true_fds(1,2:79));
dn_spat_true_fds = table2array(grad_true_fds(2,2:79));
ga_spat_true_fds = table2array(grad_true_fds(3,2:79));
rn_spat_true_fds = table2array(grad_true_fds(4,2:79));
ecm_temp_true_fds = table2array(grad_true_fds(5,2:79));
ita_spat_true_fds = table2array(grad_true_fds(6,2:79));
mde_temp_true_fds = table2array(grad_true_fds(7,2:79));
dm_spat_true_fds = table2array(grad_true_fds(8,2:79));
alpha_spat_true_fds = table2array(grad_true_fds(9,2:79));
...
figure
plot(x11_res, tc_temp_true_gam, 'r--')
hold on;
plot(x11_res, tc_temp_true_fds, '-','Color',[0.61 0.51 0.74])
plot(x11_res, tc_temp_cv1,'k-')
plot(x11_res, tc_temp_cv2,'g-')
plot(x11_res, tc_temp_cv3,'b-')
plot(x11_res, tc_temp_cv4,'c-')
plot(x11_res, tc_temp_cv5,'m-')
%xlim([0 0.11])
%ylim([0 0.004])
...
figure
plot(x11_res, dn_spat_true_gam, 'r--')
hold on;
plot(x11_res, dn_spat_true_fds, '-','Color',[0.61 0.51 0.74])
...
%% Haptotaxis term
figure
plot(x11_res, ga_spat_true_gam, 'r--')
hold on;
plot(x11_res, ga_spat_true_fds, '-','Color',[0.61 0.51 0.74])
...
figure
plot(x11_res, rn_spat_true_gam, 'r--')
hold on;
plot(x11_res, rn_spat_true_fds, '-','Color',[0.61 0.51 0.74])
...
figure
plot(x11_res, ecm_temp_true_gam, 'r--')
hold on;
plot(x11_res, ecm_temp_true_fds, '-','Color',[0.61 0.51 0.74])
...
%% Decay of ECM.
figure
plot(x11_res, ita_spat_true_gam, 'r--')
hold on;
plot(x11_res, ita_spat_true_fds, '-','Color',[0.61 0.51 0.74])
...
figure
plot(x11_res, mde_temp_true_gam, 'r--')
hold on;
plot(x11_res, mde_temp_true_fds, '-','Color',[0.61 0.51 0.74])
...
figure
plot(x11_res, dm_spat_true_gam, 'r--')
hold on;
plot(x11_res, dm_spat_true_fds, '-','Color',[0.61 0.51 0.74])
...
figure
plot(x11_res, alpha_spat_true_gam, 'r--')
hold on;
plot(x11_res, alpha_spat_true_fds, '-','Color',[0.61 0.51 0.74])
